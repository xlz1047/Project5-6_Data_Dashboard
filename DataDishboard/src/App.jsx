  ...
  return (
    <div className="app-container">
      ...
      <div className="statistics">
        ...
        <p>Micro Breweries: {data.filter(b => b.brewery_type === "micro").length}</p>
        <p>Regional Breweries: {data.filter(b => b.brewery_type === "regional").length}</p>
      </div>
      ...
      <ul className="brewery-list">
        {filteredData.map((brewery) => (
          <li key={brewery.id}>
            ...
            <Link to={`/detail/${brewery.id}`}>More details</Link>
          </li>
        ))}
      </ul>
